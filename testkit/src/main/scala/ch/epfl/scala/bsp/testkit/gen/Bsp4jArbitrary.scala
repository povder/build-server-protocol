...
trait Bsp4jArbitrary {
  ...
  implicit val arbExcludeItem: Arbitrary[ExcludeItem] = Arbitrary(genExcludeItem)
  implicit val arbExcludeItemKind: Arbitrary[ExcludeItemKind] = Arbitrary(genExcludeItemKind)
  implicit val arbExcludesItem: Arbitrary[ExcludesItem] = Arbitrary(genExcludesItem)
  implicit val arbExcludesParams: Arbitrary[ExcludesParams] = Arbitrary(genExcludesParams)
  implicit val arbExcludesResult: Arbitrary[ExcludesResult] = Arbitrary(genExcludesResult)
